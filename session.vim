...
silent only
silent tabonly
cd /media/admin/New\ Volume/Desktop/Python_files/probot
...
exe 'vert 2resize ' . ((&columns * 48 + 84) / 168)
exe '3resize ' . ((&lines * 30 + 21) / 43)
exe 'vert 3resize ' . ((&columns * 119 + 84) / 168)
argglobal
...
wincmd w
argglobal
if bufexists("/media/admin/New\ Volume/Desktop/Python_files/probot/probot.py") | buffer /media/admin/New\ Volume/Desktop/Python_files/probot/probot.py | else | edit /media/admin/New\ Volume/Desktop/Python_files/probot/probot.py | endif
balt ~/.vim/bundle/vim-snippets/UltiSnips/python.snippets
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((7 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 55
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 80 + 84) / 168)
exe 'vert 2resize ' . ((&columns * 87 + 84) / 168)
argglobal
...
wincmd w
argglobal
if bufexists("/media/admin/New\ Volume/Desktop/Python_files/probot/data.conf") | buffer /media/admin/New\ Volume/Desktop/Python_files/probot/data.conf | else | edit /media/admin/New\ Volume/Desktop/Python_files/probot/data.conf | endif
balt /media/admin/New\ Volume/Desktop/Python_files/probot/probot.py
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
badd +1 /media/admin/New\ Volume/Desktop/Python_files/probot/data.conf
